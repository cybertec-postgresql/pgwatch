...
type CmdOpts struct {
	...
	PgBatchingDelay       time.Duration `long:"pg-batching-delay" mapstructure:"pg-batching-delay" description:"Timeout to wait in postgres sink for a batched metrics flush" default:"950ms" env:"PW_PG_BATCHING_DELAY"`
