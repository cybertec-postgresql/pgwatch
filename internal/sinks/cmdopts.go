...
type CmdOpts struct {
	...
	PartitionInterval     string        `long:"partition-interval" mapstructure:"partition-interval" description:"PostgreSQL partition interval (1 day, 1 week, or 1 month)" default:"1 week" env:"PW_PARTITION_INTERVAL"`
