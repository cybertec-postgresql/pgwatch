...
type CmdOpts struct {
	...
	Retention             time.Duration `long:"retention" mapstructure:"retention" description:"If set, metrics older than that will be deleted" default:"14 days" env:"PW_RETENTION"`
	Maintenance           time.Duration `long:"maintenance" mapstructure:"maintenance" description:"If set, periodic maintenance will be performed with this interval" default:"12 hours" env:"PW_MAINTENANCE"`
