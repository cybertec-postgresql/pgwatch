...
type CmdOpts struct {
	...
	WebBasePath   string `long:"web-base-path" mapstructure:"web-base-path" description:"Base path for web UI and API endpoints ('pgwatch' or '/pgwatch/')" env:"PW_WEBBASEPATH"`
